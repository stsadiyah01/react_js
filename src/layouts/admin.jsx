        ...
        <nav className="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex justify-start items-center">
              ...
              >
                <img
                  ...
                  className=" mr-1 h-10 w-15 sm:h-30 sm:w-30"
                  alt="TokoBuku Logo"
                />
            ...
            <div className="flex items-center lg:order-2">
              ...
              <Link to="/" className=" bg-white hover:bg-gray-200 focus:ring-4 focus:ring--300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none">
                    {userInfo.name}
                  </Link>
              ...
              >
                ...
                <ul
                  className="py-1 space-y-2  text-gray-700 dark:text-gray-300"
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  className="flex items-center p-2 text-base font-medium text-red-900 rounded-lg transition duration-75 bg-red-200 hover:bg-red-100 dark:hover:bg-red-700 dark:text-white group"
                >
